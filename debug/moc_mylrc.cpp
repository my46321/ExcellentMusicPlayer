...
QT_MOC_LITERAL(1, 6, 12), // "changeselect"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7), // "timeout"
QT_MOC_LITERAL(4, 28, 11), // "downloadLrc"
QT_MOC_LITERAL(5, 40, 13), // "replyFinished"
QT_MOC_LITERAL(6, 54, 14), // "QNetworkReply*"
QT_MOC_LITERAL(7, 69, 5) // "reply"

    },
    "MyLrc\0changeselect\0\0timeout\0downloadLrc\0"
...
void MyLrc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeselect((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->timeout(); break;
        case 2: _t->downloadLrc(); break;
        ...
        {
            typedef void (MyLrc::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLrc::changeselect)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MyLrc::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MyLrc.data,
...
// SIGNAL 0
void MyLrc::changeselect(bool _t1)
{
