...
class MyMainDlg : public QDialog
{
    Q_OBJECT
signals:
    void SignalSetSongValue(QString strText);
public:
    ...
    QString play_style;
    QString pause_style;
    QString order0_style;
    QString order1_style;
    QString order2_style;
...
///////////////////////////////////////
    ...
    QListWidgetItem* mylistWidgetItem[6];

    QLabel *loadlab,*addtips;
    bool mylanguage;
    bool mylove[100];
    QTableWidgetItem* myloveptr[100];
...
protected:
     ...
     bool eventFliter(QObject*,QEvent *);
public slots:
     void downloadsonginfo(int,QString);//网上下载歌曲
     void delete_downloadDialog();

private slots:

     void setmylove();
     void mylovedoubleclick(QTableWidgetItem*);
...
////////////////////
    ...
    mymaintablewidget *mymaintable ,*mynetmaintable,*mylovetable;
